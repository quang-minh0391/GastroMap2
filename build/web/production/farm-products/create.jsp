...
<head>
    ...
    <title>Thêm Nông sản - GastroMap</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header bg-white">
                        <h4 class="mb-0">
                            <i class="bi bi-plus-circle"></i> Thêm Nông sản mới
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/farm-products" method="post">
                            ...
                            <div class="mb-3">
                                <label for="name" class="form-label">Tên nông sản <span class="text-danger">*</span></label>
